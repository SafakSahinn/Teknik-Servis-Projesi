...
<body>
    <div class="sidenav">
        <div class="row side_top">
            <div class="col-4 side_top_left">
                <img src="web/images/technical-support.png" alt="news image" class="img-fluid navimg">
            </div>
    ...
    <div class="main" id="home">
        <div class="banner-text-w3ls">
            <div class="container">
                <div class="mx-auto text-center">
                    <h1>En ucuz fiyatlarla, en kaliteli binlerce ürün bir tıkla kapınızda.</h1>
        ...
        <section class="slide-wrapper" id="about">
            ...
            <img src="web/images/hakkımızda.jpg" class="img-fluid" alt="">
            <p class="iner mt-5">
        ...
        <div class="wthree_pvtits-services align-w3" id="services">
            <div class="container">
                <div class="wthree_pvt_title text-center">
                    ...
                    <p class="main_p mb-5  text-center mx-auto">Mağazamızdan almış olduğunuz ürünlerde herhangi bir teknik problem oluşursa, 2 yıl süre ile herhangi bir ücret ödemeden teknik destek hizmetimizden yaralanabilirsiniz.</p>
        ...
        <section class="wedo" id="contact">
            ...
            <p class="main_p mb-5  text-center mx-auto">Mağazamız ya da satın almış olduğun herhangi bir ürün ile ilgili sorun oluşursa bize mesaj atarak ulaşabilirsiniz. En kısa sürede sizlerle iletişime geçilecektir.</p>
